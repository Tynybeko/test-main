...
const suitable_data = [
  {
    ...
    title: (
      <>
        Join <span>With</span>  Us:
      </>
    ),
    des: <>Embark on a learning adventure with us! Do you want to learn here? Discover our diverse courses and find your perfect fit for growth.</>,
  ...
  },
  {
    ...
    title: (
      <>
        Which One is <span>Suitable</span> For You?
      </>
    ),
    des: <>Curious about learning here? Explore our options, and let's find the ideal course that suits your educational journey.</>,
    img: "/assets/img/bg/suit-bg-02.png",
  },
];

const SuitableArea = ({ style_2 }: { style_2?: undefined | boolean }) => {
  return (
    <>
      <section
