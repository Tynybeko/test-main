                  ...
                  <div className="col-lg-8 col-md-12">
                     <div className="c-details-wrapper mr-25">
                        ...
                        <div className="c-details-about mb-40">
                           ...
                           <p>Embark on a transformative journey into the world of web design with our comprehensive UI/UX Masterclass in Adobe XD. This course is crafted for both beginners and experienced designers seeking to elevate their skills.</p>
                           <p>Whether you're starting your design journey or looking to enhance your expertise, this Masterclass provides a solid foundation and advanced techniques to create stunning, user-centric web designs. Join us and unlock the keys to successful UI/UX mastery. Enroll now and design the future!</p>
                        </div>
                        <div className="cor-details-instructor mb-40">
                           ...
                           <p>With a passion for excellence and a commitment to delivering unparalleled training, Hossain Mahmud stands as a beacon in the world of design education. Join his class to elevate your skills, whether you're delving into the realm of chemicals or honing your craft in user interface design. Enroll now and embark on a journey of award-winning learning!</p>
                        </div>
